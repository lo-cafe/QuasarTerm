...
import AppKit
// Sourve: https://gist.github.com/stephancasas/d03f25bdf43c2ae55a41d70ec4f80e50
import SwiftUI
...
class AdvancedToolbarWindow<MainContent: View, ToolbarContent: View, TitleToolbarContent: View>: NSWindow, NSToolbarDelegate {
    ...
    convenience init(
        withTitle: String,
        contentRect _: NSRect = CGRect(x: 0, y: 0, width: 620, height: 400),
    ...
    init(
        ...
        toolbarContent = withToolbar
        titleToolbarContent = withTitleToolbar
    ...
    func installToolbarAccessory<T: View>(
